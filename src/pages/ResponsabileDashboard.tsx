      ...
      <div className="card mb-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link
            ...
            className="hidden sm:block p-4 border border-gray-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 transition-colors"
          >
            <h3 className="font-medium text-gray-900">Gestione Clienti</h3>
            <p className="text-sm text-gray-500 mt-1">
              Aggiungi e modifica i clienti
            </p>
          </Link>

          <Link
            to="/responsabile/cantieri"
            className="hidden sm:block p-4 border border-gray-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 transition-colors"
          >
            <h3 className="font-medium text-gray-900">Gestione Cantieri</h3>
            <p className="text-sm text-gray-500 mt-1">
              Gestisci i cantieri per ogni cliente
            </p>
          </Link>

          <Link
            to="/responsabile/tipi-attivita"
            className="hidden sm:block p-4 border border-gray-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 transition-colors"
          >
            <h3 className="font-medium text-gray-900">Gestione Tipi Attivita</h3>
            <p className="text-sm text-gray-500 mt-1">
              Gestisci i tipi di attivita disponibili
            </p>
          </Link>
          ...
          >
            <h3 className="font-medium text-gray-900">Report Attivita</h3>
            <p className="text-sm text-gray-500 mt-1">
              Visualizza e esporta i report delle attivita
            </p>
          </Link>
          ...
          <Link
            ...
            className="p-4 border border-gray-200 rounded-lg hover:border-primary-300 hover:bg-primary-50 transition-colors"
          >
            <h3 className="font-medium text-gray-900">Assegna Attivita</h3>
            <p className="text-sm text-gray-500 mt-1">
